                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group my-1">
                                                        ...
                                                        <input type="text" name="rod_size" class="form-control" placeholder="Rod Size">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group my-1">
                                                        <label for="" class="text-dark">Product Weight</label><span style="color: red; font-size:0.8rem"> ( Only in KG )</span>
                                                        <input type="number" name="weight" class="form-control" placeholder="eg: 100kg">
                                                    </div>
                                                    <div class="form-group my-1">
                                                        <label for="" class="text-dark">Product Length</label>
                                                        <input type="number" name="length" class="form-control" placeholder="eg: 100mm">
                                                    </div>
                                                    <div class="form-group my-1">
                                                        <label for="" class="text-dark">Product Air Consumption</label>
                                                        <input type="text" name="air_consumption" class="form-control" placeholder="Air Consumption">
                                                    </div>
                                                    <div class="form-group my-1">
                                                        <label for="" class="text-dark">Product Strokes x mins</label>
                                                        <input type="text" name="strokes_x_mins" class="form-control" placeholder="Strokes x mins">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
